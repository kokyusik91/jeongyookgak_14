  ...
  return (
    <React.Fragment>
      ...
      <Grid width="60vw" margin="4rem auto" flex>
        ...
        value="PORK" margin="0 5px 0 0px" onClick={(e)=>{
          handleCategory(e)
          checkValue()
        }}>
          돼지
        ...
        value="BEEF" margin="0 5px 0 0" onClick={(e)=>{
          handleCategory(e)
          checkValue()
        }}>
          소
        ...
        value="CHICKEN" margin="0 5px 0 0" onClick={(e)=>{
          handleCategory(e)
          checkValue()
        }}>
          닭
        ...
        value="SEAFOOD" margin="0 5px 0 0" onClick={(e)=>{
          handleCategory(e)
          checkValue()
        }}>
          수산
        ...
        value="MEALKIT" margin="0 5px 0 0" onClick={(e)=>{
          handleCategory(e)
          checkValue()
        }}>
          밀키트
        ...
        value="MILK" margin="0 5px 0 0" onClick={(e)=>{
          handleCategory(e)
          checkValue()
        }}>
          우유
        ...
        value="EGG" margin="0 5px 0 0" onClick={(e)=>{
          handleCategory(e)
          checkValue()
        }}>
          달걀
        ...
        value="BABY" margin="0 5px 0 0" onClick={(e)=>{
          handleCategory(e)
          checkValue()
        }}>
          이유식
